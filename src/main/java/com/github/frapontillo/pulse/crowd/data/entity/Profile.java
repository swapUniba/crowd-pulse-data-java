...
/**
 * Profiles are entities describing the user information available on the social network being
 * analyzed.
 *
...
public class Profile extends Entity implements Comparable<Profile> {
    ...
    /**
     * Get the number of followers (users who follow the Profile) the user has on the social
     * network at extraction time.
     *
    ...
    /**
     * Set the number of followers (users who follow the Profile) the user has on the social
     * network at extraction time.
     *
    ...
    /**
     * Get the location of the Profile as a {@link String}. This piece of information may not
     * always be available.
     *
    ...
    /**
     * Get a representation of the Profile by including the source and the username. This
     * representation is called identity as there is no more than one profile with the same
     * representation.
     *
    ...
    /**
     * Get a {@link String} representation of the Profile by including its id and identity (see
     * {@link
     * #getIdentityRepr()}).
     *
     ...
     *
     * @return An negative integer if the Profile is logically previous to the input one, 0 if it is
     * the same, positive if it is logically next to the input one.
     */

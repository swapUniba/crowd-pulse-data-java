 ...
 */
public class MessageRxFetcher
        extends IPlugin<Object, Message, MessageRxFetcher.MessageFetcherOptions> {
    public final static String PLUGIN_NAME = "message-rx-fetch";
    private MessageRepository messageRepository;
    private final Logger logger = PulseLogger.getLogger(MessageRxFetcher.class);
        ...
        return subscriber -> new SafeSubscriber<>(new Subscriber<Object>() {
            @Override public void onCompleted() {
                Observable<Message> dbMessages = messageRepository
                        .findRx(parameters.getSince(), parameters.getUntil(),

...
public class Token {
    ...
    /**
     * Get a simpler version of the Part-of-Speech. There's no restriction on the validity of the
     * simple POS, but implementations <i>should</i> use the following simpler POS: "n", "v", "a",
     * "r".
     *
    ...
    /**
     * Set a simpler version of the Part-of-Speech. There's no restriction on the validity of the
     * simple POS, but implementations <i>should</i> use the following simpler POS: "n", "v", "a",
     * "r".
     *
